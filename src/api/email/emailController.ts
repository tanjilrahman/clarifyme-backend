...
import SubscriptionEmail, { type SubscriptionInfo } from "@/emails/subscription";
...
class EmailController {
  ...
  public confirmSubscription: RequestHandler = async (req: Request, res: Response) => {
    try {
      const subscriptionInfo: SubscriptionInfo = req.body;
      ...
      if (response.data) {
        const serviceResponse = ServiceResponse.success("Subscription email sent!", response.data);
        return handleServiceResponse(serviceResponse, res);
      } else {
        const serviceResponse = ServiceResponse.failure("Error!", response.error);
        return handleServiceResponse(serviceResponse, res);
